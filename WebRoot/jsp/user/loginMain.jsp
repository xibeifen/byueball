...
<!--header-->
	<div class="header">
		<div class="header-top">
			<div class="container">
			<p class="header-para">欢迎您：<s:property value="#session.existTeam.capName" /></p>
			    <ul class="sign">
					<li ><a href="${pageContext.request.contextPath}/Main.jsp" >退出</a></li>
...
<div class="header-bottom-top">
		<div class="container">
			...
			<div class="header-bottom">			
				...
				<div class="top-nav">
					<ul>
						<li class="active" ><a href="${pageContext.request.contextPath}/jsp/user/loginMain.jsp" class="scroll"> 首页</a></li>
